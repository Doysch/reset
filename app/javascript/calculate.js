...
// console.log(latEnding);
// let lngEnding = latLng.waypoints[1].location[0];
// console.log(lngEnding);


// 3. Place into Mapbox API

// fetch('https://api.mapbox.com/directions/v5/mapbox/walking/{coordinates}')
...
// 4. Fetch the figure from API and replace the hardcoded time on index page
